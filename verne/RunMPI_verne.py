...
if __name__ == '__main__':
    ...
    parser.add_argument('-target', '--target', help='Location of detector: "MPI" or "SUF"',
    ...
    outfile = "outputs/out_" + args.target + "_lmx" + '{0:.1f}'.format(
        np.log10(args.m_x)) + "_lsig" + '{0:.2f}'.format(np.log10(sig)) + ".txt"
