...
def getVelDist(mstr, lsigstr, gamma_ind):
    ...
    gamma_vals1, vvals1, fvals1 = np.loadtxt(
        "../results/veldists/f_SUF_lmx" + mstr + "_lsig" + lsigstr + ".txt", unpack=True)
...
if __name__ == '__main__':
    ...
    if (not os.path.isfile(fname)):
        htxt = "Total number of CDMS-I signal events at SUF (signal averaged over 1 day). Log10(m_x) = " + "{0:.1f}".format(
